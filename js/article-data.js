const articleDetails = {
    ...
    "welcome-to-daruma-street-news": {
        ...
        hero: "assets/news/welcome-to-daruma-street-news/main.jpg",

        content: {

            en: `Welcome to DARUMA STREET NEWS.

This is where we share what's happening behind the brand.

From new product releases and BMX videos to team updates, events, tours, and collaborations, this page documents the ongoing story of DARUMA STREET.

Rather than simply announcing what's new, we also want to share the ideas, projects, and moments that shape the brand over time.

As the brand continues to grow, this archive will grow with it.`,

            ja: `DARUMA STREET NEWSへようこそ。

このページでは、新商品のリリースやBMXビデオ、チームライダー、イベント、ツアー、コラボレーションなど、DARUMA STREETの活動を発信していきます。

単なるお知らせではなく、ブランドを形づくるプロジェクトや、その背景、ストリートで生まれた出来事を記録し、DARUMA STREETの歩みとして積み重ねていく場所です。
...
圧巻のライディングスキルと、オリジナリティ溢れるスポットチョイスで、唯一無二の世界観を表現し続けるBMXライダー。`

    },

    videos: [
        "https://www.youtube.com/watch?v=vfrn9b3SW5k",
        "https://www.youtube.com/watch?v=FSZEAOTpwfE"
    ],
...
"rick-maruyama-rider-introduction": {
...
気さくな人柄で誰からも愛されるキャラクター。テクニカルなライディングからハンマーまでを網羅し、あらゆるスポットを攻略するBMXライダー。ツアー中のビデオクリップの撮れ高も随一の仕事人。`

    },

    videos: [
        "https://www.youtube.com/watch?v=ciQ8en2O1do",
        "https://www.youtube.com/watch?v=PUgc5dEwU3E"
    ],
...
"kazuma-sato-rider-introduction": {
...
硬派なストリートライディングを軸とする、ザ・いぶし銀BMXライダー。石川を拠点に活動する「NICE KUSO SPOT」の代表として、ローカルシーンを盛り上げている。`

    },

    videos: [
        "https://www.youtube.com/watch?v=BPbSgf6omM8",
        "https://youtu.be/VrirJcYxybo?si=K9BboLVkR5ft6ev1"
    ],
...
"natsuki-taniguchi-rider-introduction": {
    ...
    hero: "assets/riders/natsuki.jpg",
...
BMXライダーとして活動する傍ら、フォトグラファーやフィルマーとしても活躍。DARUMA STREETのチームマネージャー的存在として、ライディングだけでなくチーム全体を支えている。`

    },

    videos: [
        "https://www.youtube.com/watch?v=PCsCof_ntAo",
        "https://www.youtube.com/watch?v=rZAyvaZ_Xvk"
    ],
...
当時まだ小中学生だったRICKと、YUも加わった総勢11名のライダーを撮影し、富山・石川を中心に、県外の様々なスポットを洗い出し、足を運びながら映像を制作しました。

応募も終え、MBFFの開催日当日。
結果発表は当日の映画館で、映像の上映と同時に発表される方式。
そもそも自分達の作品が流れるのかも分からないドキドキの中で、他の作品を見ていました。
そんな中、上映開始から３作目でDARUMA STREETの文字がスクリーンに表示され、感動とかより先に、安堵しました。
...
`
    ...
    videos: [
        "https://youtube.com/shorts/OYh6nC63ng0?si=2JVjBBMwodh5Ggrr"
    ],
